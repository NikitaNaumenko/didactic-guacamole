  ...
  const routes = [
    {
      name: "index",
      path: "/",
      controller: "SentinelWeb.PageController",
      params: [],
      action: "home",
      method: "GET",
    },
    {
      ...
      path: "/registration",
      controller: "SentinelWeb.Web.RegistrationController",
      params: [],
      action: "new",
      method: "GET",
    },
    ...
    },
    {
      name: "sign_in.new",
      path: "/sign_in",
      controller: "SentinelWeb.Web.SignInController",
      params: [],
      action: "new",
      method: "GET",
    },
    ...
    },
    {
      name: "index",
      path: "/",
      controller: "SentinelWeb.Web.HomeController",
      params: [],
      action: "home",
      method: "GET",
    },
    {
      name: "monitors.index",
      path: "/monitors",
      controller: "SentinelWeb.Web.MonitorController",
      params: [],
      action: "index",
      method: "GET",
    },
    {
      name: "monitors.edit.edit",
