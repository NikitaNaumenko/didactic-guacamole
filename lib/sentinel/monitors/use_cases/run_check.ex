defmodule Sentinel.Monitors.UseCases.RunCheck do
  ...
  defp process_incident(%Monitor{last_check: %Check{result: :success}} = monitor, %Check{id: check_id, result: :success}) do
    update_monitor(monitor, %{last_check_id: check_id})
  end
  ...
  defp process_incident(%Monitor{last_check: %Check{result: :failure}} = monitor, %Check{id: check_id, result: :failure}) do
    update_monitor(monitor, %{last_check_id: check_id})
  end
